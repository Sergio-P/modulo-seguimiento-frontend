...
export default function CaseForm(props: CaseFormProps) {
  ...
  const tieneMetastasis: boolean = useWatch({control, name: "tiene-metastasis", defaultValue: false});
  const tieneRecurrencia: boolean = useWatch({control, name: "tiene-recurrencia", defaultValue: false});
  const tieneProgresion: boolean = useWatch({control, name: "tiene-progresion", defaultValue: false});
        ...
        >
          ...
          <Section id="diagnostico" title="Diagnóstico">
            ...
            <SubSection title="Validación">
              <div className="grid grid-cols-3 max-w-5xl">
                ...
                <Checkbox className="col-start-3 flex items-center"
          ...
          <Section id="tratamiento" title="Antecedentes Tratamiento (Estado XXX)">
            ...
            <SubSection title="Lista de Tratamientos">
              ...
              <div className="grid max-w-5xl grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                <div>
                  <Controller
