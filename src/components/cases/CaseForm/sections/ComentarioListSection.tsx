...
export default function ComentarioListSection({}: ComentarioListProps) {
  ...
  if (!comentarios) {
    return <div className="font-semibold text-font-subtitle">No hay comentarios aún.</div>;
  }
  return (
          ...
          <div>
            {comentarios.map((comentario) => (
              <div className="flex-col rounded-lg bg-background-dark px-3 py-2 m-4">
                ...
                <div className="flex pt-3 justify-end gap-8 font-semibold text-font-subtitle">
